...
export class ApiService {
    ...
    private mockClasses: WorkoutClass[] = [
        { id: '1', baseName: 'machi', className: 'TRX & Core', dayOfWeek: 1, startTime: '06:00', instructor: 'סגן אורן', capacity: 20, registeredCount: 18 },
        { id: '2', baseName: 'machi', className: 'CrossFit', dayOfWeek: 1, startTime: '17:30', instructor: 'רס"ר כהן', capacity: 30, registeredCount: 30 },
        { id: '3', baseName: 'batzet', className: 'Morning Run', dayOfWeek: 1, startTime: '05:30', instructor: 'סמ"ר דוד', capacity: 50, registeredCount: 12 },
        { id: '4', baseName: 'zis', className: 'Combat Fitness', dayOfWeek: 2, startTime: '16:00', instructor: 'סרן לוי', capacity: 25, registeredCount: 22 },
    ...
    addHydrationCup() {
        ...
        if (!current) return
        this.mockDashboardData.hydrationCups = Math.min(current.hydrationCups + 1, current.hydrationGoal)
        this.dashboard.set({ ...this.mockDashboardData })
    }
